...
@Component({
    ...
    template: `
        ...
        <div class="layout-config" [ngClass]="{'layout-config-active': appMain.configDialogActive}" (click)="appMain.onConfigClick()">
            ...
            <h5>Wrapper Mode</h5>
            <div class="field-radiobutton">
                <p-radioButton name="wrapMode" [value]="false" [(ngModel)]="app.wrapperMode" [disabled]="appMain.isMobile()" inputId="wrapMode1"></p-radioButton>
                <label for="wrapMode1">Boxed</label>
            </div>
            <div class="field-radiobutton">
                <p-radioButton name="wrapMode" [value]="true" [(ngModel)]="app.wrapperMode" [disabled]="appMain.isMobile()" inputId="wrapMode2"></p-radioButton>
